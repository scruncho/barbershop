                                        ...
                                        <div class="row">
                                         <div class="col-md-7">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="search" vlaue="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>" class="form-control" placeholder="Search Member" >
...
?>
    ...
    <td>
     ...
     <a onclick= "return confirm('Are you sure you want to delete this  record?');"
         href="delete.php?id=<?php echo $items['members_id']  ?>" class="btn btn-danger">Delete</a> 
</td>
